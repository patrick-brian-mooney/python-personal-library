...
# This part of the script is currently heavily dependent on the structure of these Magic Lantern (firmware 1.0.2-ml-v2.3) scripts
    ...
    for which_script in glob.glob('HDR*SH'):
        ...
        with open(which_script, 'r') as the_script:
            ...
            if script_lines[4].startswith('align_image_stack'):         # It's an align-first script, with 8 lines, 5 non-blank.
                ...
                align_line = align_line + ' '.join([file_name_mappings[which_file] for which_file in align_line_tokens[4:]]) + '\n'
